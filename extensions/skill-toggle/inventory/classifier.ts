import { getDisableModelInvocation } from "../frontmatter/validation";
import type { FrontmatterDocument, SkillInvocationMode, SkillSource } from "../types";
...
export function sourceCategory(source: SkillSource): "global" | "user" | "project" | "unknown" {
  ...
  if (source.kind === "global" || source.kind === "user" || source.kind === "project")
    return source.kind;
  return "unknown";
}
